...
with header:
    ...
    st.write('SciMatch searches in PubMed for publications similar to your input. The results will identify scientists who have worked on these papers. You can view a basic list of these researchers, explore a world map to see where they are working globally, or analyze how closely related their work is.')
with inputdata:
    ...
    top_k = st.slider("How many papers should we look for? Keep in mind, that the processing time increases with the number of papers to search for.", min_value=5, max_value=50, value=5, step=5)
